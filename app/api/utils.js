// generates and manipulates the tokens
// uses one of the libraries we have installed
// first method generates a token
// second decodes an existing token, recovering the encrypted fields.
// we are basing the token on the User ID + email.
